...
const {
	...
	addBypassClientIP,
	addForwardClientIP,
	removeBypassClientIP,
	removeBypassIP,
	removeForwardClientIP,
	removeForwardIP
} = service
...
const controller: ServiceController = {
	...
	setSSMode,
	getBypassIPList: async () => getBypassIPList(),
	getForwardIPList: async () => getForwardIPList(),
	getBypassClientIPList: async () => getBypassClientIPList(),
	getForwardClientIPList: async () => getForwardClientIPList(),
	addBypassIP,
	addForwardIP,
	addBypassClientIP,
	addForwardClientIP,
